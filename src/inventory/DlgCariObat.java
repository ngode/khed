...
//private String bangsal="",bangsaldefault=Sequel.cariIsi("select kd_bangsal from set_lokasi limit 1"),tampilkan_ppnobat_ralan="";
    ...
    private void initComponents() {
        ...
        FormInput.add(LPpn);
        LPpn.setBounds(170, 70, 65, 23);

        jLabel7.setText("Total+PPN :");
        jLabel7.setName("jLabel7"); // NOI18N
        jLabel7.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(jLabel7);
        jLabel7.setBounds(240, 70, 65, 23);
        ...
        LTotalTagihan.setBounds(310, 70, 80, 23);
        ...
        Jeniskelas.setBounds(440, 40, 150, 23);
        ...
        ChkNoResep.setBounds(600, 40, 85, 23);

        jLabel8.setText("Tanggal :");
        jLabel8.setName("jLabel8"); // NOI18N
        jLabel8.setPreferredSize(new java.awt.Dimension(68, 23));
        FormInput.add(jLabel8);
        jLabel8.setBounds(0, 40, 55, 23);

        DTPTgl.setEditable(false);
        DTPTgl.setForeground(new java.awt.Color(50, 70, 50));
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-01-2018" }));
        ...
        ChkJln.setBounds(320, 40, 22, 23);

        label21.setText("Depo :");
        label21.setName("label21"); // NOI18N
        label21.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label21);
        label21.setBounds(380, 70, 50, 23);
        ...
        kdgudang.setBounds(440, 70, 55, 23);

        nmgudang.setEditable(false);
        nmgudang.setName("nmgudang"); // NOI18N
        nmgudang.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(nmgudang);
        nmgudang.setBounds(500, 70, 150, 23);
        ...
        BtnGudang.setBounds(650, 70, 28, 23);
