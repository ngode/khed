...
public class DlgPenjualanPerTanggal extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penjualan Bebas Obat/Alkes/BHP Per Tanggal ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(90, 120, 80))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Map<String, Object> param = new HashMap<>();   
                ...
                if(lokasi.equals("")){
                    Valid.MyReport("rptPenjualanPerTanggal.jrxml","report","::[ Penjualan Bebas Obat/Alkes/BHP Per Tanggal ]::","select * from temporary",param);            
                }else if(!lokasi.equals("")){                    
                    param.put("bangsal",lokasi);
                    Valid.MyReport("rptPenjualanPerTanggal2.jrxml","report","::[ Penjualan Bebas Obat/Alkes/BHP Per Tanggal ]::","select * from temporary",param);            
                }
