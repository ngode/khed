 ...
 * @author dosen
 */
public final class DlgKategoriLab extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgKategoriLab(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ps=koneksi.prepareStatement(
                "select kd_jenis_prw, nm_perawatan from jns_perawatan_lab where kd_jenis_prw like ? "+
                "or nm_perawatan like ? ");
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Kategori Laboratorium ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 40))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.menyimpan("jns_perawatan_lab","?,?,?,?","Kode Kategori",4,new String[]{
                TKd.getText(),TNm.getText(),"1","1"
            });
            tampil();
            emptTeks();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbKategori.getRowCount();i++){ 
            if(tbKategori.getValueAt(i,0).toString().equals("true")){
                Sequel.meghapus("jns_perawatan_lab","kd_jenis_prw",tbKategori.getValueAt(i,1).toString());
            }
        } 
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"jns_perawatan_lab","kd_jenis_prw","?","kd_jenis_prw=?,nm_perawatan=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKategoriLab dialog = new DlgKategoriLab(new javax.swing.JFrame(), true);
