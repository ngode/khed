 ...
 * @author dosen
 */
public final class DlgTarifLab extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgTarifLab(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={
            ...
            "K.S.O.","Menejemen","Total Tarif","Kelas"};
    ...
    private void initComponents() {
        ...
        FormInput.add(TNm);
        TNm.setBounds(370, 10, 250, 23);

        jLabel9.setText("Jasa RS: Rp.");
        ...
        jLabel5.setBounds(360, 130, 90, 23);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTarifLab dialog = new DlgTarifLab(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                        "select id_tarif,id_template,bagian_rs,bhp,bagian_perujuk,bagian_dokter,bagian_laborat,kso,menejemen,biaya_item,kelas"+
                        " from tarif_lab order by id_tarif");
            try {    
...
//        nmpnj.setText("");
    ...
    private void getData() {
        if(tbJnsPerawatan.getSelectedRow()!= -1){
            ...
            Kelas.setSelectedItem(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),11).toString());
