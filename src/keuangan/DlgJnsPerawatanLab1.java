 ...
 * @author dosen
 */
public final class DlgJnsPerawatanLab1 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgJnsPerawatanLab1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJnsPerawatanLab1 dialog = new DlgJnsPerawatanLab1(new javax.swing.JFrame(), true);
