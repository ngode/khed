 ...
 * @author dosen
 */
public final class DlgJnsPerawatanLabAseli extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgJnsPerawatanLabAseli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJnsPerawatanLabAseli dialog = new DlgJnsPerawatanLabAseli(new javax.swing.JFrame(), true);
