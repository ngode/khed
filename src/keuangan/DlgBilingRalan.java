...
public class DlgBilingRalan extends javax.swing.JDialog
{
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-11-2017 06:25:13" }));
    ...
    public void isRawat()
    {
        ...
        if (i <= 0)
        {
            ...
            if ((chkLaborat.isSelected() == true) || (chkTarifDokter.isSelected() == true) || (chkTarifPrm.isSelected() == true) || (chkRadiologi.isSelected() == true))
            {
                ...
                {
                    true, "Tindakan", ":", "", null, null, null, null, "Ralan Dokter"
                });
            }
            ...
            if (chkSarpras.isSelected() == true)
            {
                if (detailjs > 0)
                {
                    tabModeRwJlDr.addRow(new Object[]
                    {
                        true, "", "Jasa Sarana dan Prasarana", ":", null, null, null, detailjs, "Ralan Dokter"
                    });
                }
            }
            if (chkObat.isSelected() == true)
            {
                tabModeRwJlDr.addRow(new Object[]
                {
                    true, "Obat & BHP", ":", "", null, null, null, null, "Obat"
                });
                prosesCariObat();
                if (detailbhp > 0)
                {
                    tabModeRwJlDr.addRow(new Object[]
                    {
                        true, "", "Paket Obat/BHP", ":", null, null, null, detailbhp, "Ralan Dokter"
                    });
                }
            }
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        while (rstambahan.next())
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "", rstambahan.getString("nama_biaya"), ":",
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        while (rspotongan.next())
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "", rspotongan.getString("nama_pengurangan"), ":",
        ...
        try
        {
            ...
            try
            {
                ...
                if (rsreg.next())
                {
                    ...
                    tabModeRwJlDr.addRow(new Object[]
                    {
                        true, "No.Nota", ": " + Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_nota,6),signed)),0) from nota_jalan where left(tanggal,7)='" + Valid.SetTgl(DTPTgl.getSelectedItem() + "").substring(0, 7) + "' ", Valid.SetTgl(DTPTgl.getSelectedItem() + "").substring(0, 7).replaceAll("-", "/") + "/RJ/", 6), "", null, null, null, null, "-"
                    });
                    ...
                    try
                    {
                        ...
                        if (rscaripoli.next())
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "Unit/Instansi", ": " + rscaripoli.getString(1), "", null, null, null, null, "-"
                            });
                        }
                    }
                    catch (Exception e)
                    {
                        tabModeRwJlDr.addRow(new Object[]
                        {
                            true, "Unit/Instansi", ": ", "", null, null, null, null, "-"
                        });
                        System.out.println("Notifikasi : " + e);
                    }
                    finally
                    ...
                    tabModeRwJlDr.addRow(new Object[]
                    {
                        true, "Tanggal & Jam", ": " + rsreg.getString("tgl_registrasi") + " " + rsreg.getString("jam"), "", null, null, null, null, "-"
                    });
                    tabModeRwJlDr.addRow(new Object[]
                    {
                        true, "No.RM", ": " + TNoRM.getText(), "", null, null, null, null, "-"
                    });
                    tabModeRwJlDr.addRow(new Object[]
                    {
                    ...
                    catch (Exception e)
                    {
                        tabModeRwJlDr.addRow(new Object[]
                        {
                            true, "Alamat Pasien", ": ", "", null, null, null, null, "-"
                        });
                        System.out.println("Notifikasi : " + e);
                    }
                    finally
            ...
            try
            {
                ...
                while (rscariralandokter.next())
                {
                    ...
                    if (rinciandokterralan.equals("Yes"))
                    {
                        ...
                        tabModeRwJlDr.addRow(new Object[]
                        {
                            true, "", rscariralandokter.getString("nm_perawatan"), ":",
            ...
            try
            {
                ...
                while (rscariralandrpr.next())
                {
                    ...
                    if (rinciandokterralan.equals("Yes"))
                    {
                        ...
                        tabModeRwJlDr.addRow(new Object[]
                        {
                            true, "", rscariralandrpr.getString("nm_perawatan"), ":",
        ...
        try
        {
            ...
            try
            {
                ...
                while (rscariralanperawat.next())
                {
                    ...
                    tabModeRwJlDr.addRow(new Object[]
                    {
                        true, "", rscariralanperawat.getString("nm_perawatan"), ":",
    ...
    private void prosesCariPeriksaLab()
    {
        try
        {
            String sCariLab = new GQuery()
                    .a("SELECT nm_perawatan, COUNT(*) AS jumlah, SUM(biaya_item) AS total,")
                    .a("SUM(bagian_dokter) AS totaldokter, SUM(bagian_laborat) AS totalpetugas, SUM(kso) AS totalkso, SUM(bhp) AS totalbhp")
                    ...
                    .a("WHERE periksa_lab.no_rawat = {no_rawat}")
                    .a("GROUP BY detail_periksa_lab.kd_jenis_prw")
                    .set("no_rawat", TNoRw.getText())
                    .compile();
            
            pscarilab = koneksi.prepareStatement(sCariLab);
            ...
            try
            {
                ...
                {
                    Jasa_Medik_Dokter_Laborat_Ralan += rscarilab.getDouble("totaldokter");
                    Jasa_Medik_Petugas_Laborat_Ralan += rscarilab.getDouble("totalpetugas");
                    Kso_Laborat_Ralan += rscarilab.getDouble("totalkso");
                    Persediaan_Laborat_Rawat_Jalan += rscarilab.getDouble("totalbhp");
                    ...
                    tabModeRwJlDr.addRow(new Object[]
                    {
                        true, 
                        "", 
                        rscarilab.getString("nm_perawatan"), 
                        ":",
                        null, 
                        null, 
                        null,
                        rscarilab.getDouble("total"), 
                        "Laborat"
                    });
    ...
    private void prosesCariObat()
    {
        ...
        try
        {
            ...
            try
            {
                ...
                if (rsobatlangsung.next())
                {
                    tabModeRwJlDr.addRow(new Object[]
                    {
                        true, "", "Obat & BHP ", ":", rsobatlangsung.getDouble("besar_tagihan"), 1, 0, rsobatlangsung.getDouble("besar_tagihan"), "Obat"
                    });
        ...
        if (subttl > 0)
        {
            if (tampilkan_ppnobat_ralan.equals("Yes"))
            {
                ...
                tabModeRwJlDr.addRow(new Object[]
                {
                    true, "", "" + Valid.SetAngka3(subttl + ppnobat), "", null, null, null, null, "TtlObat"
                });
            }
            else
            {
                tabModeRwJlDr.addRow(new Object[]
                {
                    true, "", "" + Valid.SetAngka3(subttl), "", null, null, null, null, "TtlObat"
                });
            }
        }
        ...
        try
        {
            ...
            try
            {
                ...
                while (rstambahan.next())
                {
                    tabModeTambahan.addRow(new Object[]
                    {
                        rstambahan.getString(1), rstambahan.getString(2)
                    });
                }
            }
            catch (Exception e)
        ...
        try
        {
            ...
            try
            {
                ...
                while (rspotongan.next())
                {
                    tabModePotongan.addRow(new Object[]
                    {
                        rspotongan.getString(1), rspotongan.getString(2)
                    });
                }
            }
            catch (Exception e)
        ...
        try
        {
            ...
            try
            {
                ...
                if (rsoperasi.next())
                {
                    tabModeRwJlDr.addRow(new Object[]
                    {
                        true, "Operasi", ":", "", null, null, null, null, "Operasi"
                    });
                }
                ...
                if (rincianoperasi.equals("Yes"))
                {
                    while (rsoperasi.next())
                    {
                        ...
                        tabModeRwJlDr.addRow(new Object[]
                        {
                            true, "                           ", rsoperasi.getString("nm_perawatan"), ":", null, null, null, null, "Operasi"
                        });
                        if (rsoperasi.getDouble("biayaoperator1") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Operator 1", ":", rsoperasi.getDouble("biayaoperator1"), 1, 0, rsoperasi.getDouble("biayaoperator1"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayaoperator2") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Operator 2", ":", rsoperasi.getDouble("biayaoperator2"), 1, 0, rsoperasi.getDouble("biayaoperator2"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayaoperator3") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Operator 3", ":", rsoperasi.getDouble("biayaoperator3"), 1, 0, rsoperasi.getDouble("biayaoperator3"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayaasisten_operator1") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Asisten Operator 1", ":", rsoperasi.getDouble("biayaasisten_operator1"), 1, 0, rsoperasi.getDouble("biayaasisten_operator1"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayaasisten_operator2") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Asisten Operator 2", ":", rsoperasi.getDouble("biayaasisten_operator2"), 1, 0, rsoperasi.getDouble("biayaasisten_operator2"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayaasisten_operator3") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Asisten Operator 3", ":", rsoperasi.getDouble("biayaasisten_operator3"), 1, 0, rsoperasi.getDouble("biayaasisten_operator3"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayainstrumen") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Instrumen", ":", rsoperasi.getDouble("biayainstrumen"), 1, 0, rsoperasi.getDouble("biayainstrumen"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayadokter_anak") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Dokter Anak", ":", rsoperasi.getDouble("biayadokter_anak"), 1, 0, rsoperasi.getDouble("biayadokter_anak"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayaperawaat_resusitas") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Perawat Resusitas", ":", rsoperasi.getDouble("biayaperawaat_resusitas"), 1, 0, rsoperasi.getDouble("biayaperawaat_resusitas"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayadokter_anestesi") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Dokter Anastesi", ":", rsoperasi.getDouble("biayadokter_anestesi"), 1, 0, rsoperasi.getDouble("biayadokter_anestesi"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayaasisten_anestesi") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Asisten Anastesi 1", ":", rsoperasi.getDouble("biayaasisten_anestesi"), 1, 0, rsoperasi.getDouble("biayaasisten_anestesi"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayaasisten_anestesi2") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Asisten Anastesi 2", ":", rsoperasi.getDouble("biayaasisten_anestesi2"), 1, 0, rsoperasi.getDouble("biayaasisten_anestesi2"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayabidan") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Bidan 1", ":", rsoperasi.getDouble("biayabidan"), 1, 0, rsoperasi.getDouble("biayabidan"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayabidan2") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Bidan 2", ":", rsoperasi.getDouble("biayabidan2"), 1, 0, rsoperasi.getDouble("biayabidan2"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayabidan3") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Bidan 3", ":", rsoperasi.getDouble("biayabidan3"), 1, 0, rsoperasi.getDouble("biayabidan3"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayaperawat_luar") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Perawat Luar", ":", rsoperasi.getDouble("biayaperawat_luar"), 1, 0, rsoperasi.getDouble("biayaperawat_luar"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayaalat") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Alat", ":", rsoperasi.getDouble("biayaalat"), 1, 0, rsoperasi.getDouble("biayaalat"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayasewaok") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Sewa OK/VK", ":", rsoperasi.getDouble("biayasewaok"), 1, 0, rsoperasi.getDouble("biayasewaok"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("akomodasi") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Akomodasi", ":", rsoperasi.getDouble("akomodasi"), 1, 0, rsoperasi.getDouble("akomodasi"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biaya_omloop") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Onloop 1", ":", rsoperasi.getDouble("biaya_omloop"), 1, 0, rsoperasi.getDouble("biaya_omloop"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biaya_omloop2") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Onloop 2", ":", rsoperasi.getDouble("biaya_omloop2"), 1, 0, rsoperasi.getDouble("biaya_omloop2"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biaya_omloop3") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Onloop 3", ":", rsoperasi.getDouble("biaya_omloop3"), 1, 0, rsoperasi.getDouble("biaya_omloop3"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biaya_omloop4") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Onloop 4", ":", rsoperasi.getDouble("biaya_omloop4"), 1, 0, rsoperasi.getDouble("biaya_omloop4"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biaya_omloop5") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Onloop 5", ":", rsoperasi.getDouble("biaya_omloop5"), 1, 0, rsoperasi.getDouble("biaya_omloop5"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("bagian_rs") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  N.M.S.", ":", rsoperasi.getDouble("bagian_rs"), 1, 0, rsoperasi.getDouble("bagian_rs"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biayasarpras") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Sarpras", ":", rsoperasi.getDouble("biayasarpras"), 1, 0, rsoperasi.getDouble("biayasarpras"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biaya_dokter_pjanak") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Dokter PJ Anak", ":", rsoperasi.getDouble("biaya_dokter_pjanak"), 1, 0, rsoperasi.getDouble("biaya_dokter_pjanak"), "Operasi"
                            });
                        }
                        ...
                        if (rsoperasi.getDouble("biaya_dokter_umum") > 0)
                        {
                            tabModeRwJlDr.addRow(new Object[]
                            {
                                true, "                           ", "  Biaya Dokter Umum", ":", rsoperasi.getDouble("biaya_dokter_umum"), 1, 0, rsoperasi.getDouble("biaya_dokter_umum"), "Operasi"
                            });
                        }
                ...
                else
                {
                    while (rsoperasi.next())
                    {
                        ...
                        tabModeRwJlDr.addRow(new Object[]
                        {
                            true, "                           ", rsoperasi.getString("nm_perawatan"), ":", rsoperasi.getDouble("biaya"), 1, 0, rsoperasi.getDouble("biaya"), "Operasi"
                        });
                        subttl = subttl + rsoperasi.getDouble("biaya");
                    }
                }
                ...
                for (r = 0; r < row2; r++)
                {
                    if (Valid.SetAngka(tbAkunBayar.getValueAt(r, 2).toString()) > 0)
                    {
                        ...
                        else if (countbayar == 1)
                        {
                            ...
                            else if (Sequel.menyimpantf2("detail_nota_jalan", "?,?,?,?", "Akun bayar", 4, new String[]
                            {
                                TNoRw.getText(), tbAkunBayar.getValueAt(r, 0).toString(), Double.toString(besarppn), Double.toString(itembayar)
                        }) == true)
                            {
