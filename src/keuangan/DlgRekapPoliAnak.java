...
public final class DlgRekapPoliAnak extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRekapPoliAnak(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Rekap Poli Anak ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(90, 120, 80))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRekapPoliAnak dialog = new DlgRekapPoliAnak(new javax.swing.JFrame(), true);
                                    ...
                                    "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                       "<tr class='isi3'>"+
                                        ...
                                        "<tr class='isi3'>"+
                                            ...
                                            "<td valign='middle' bgcolor='#f8fdf3' align='center' colspan='2'>0-6 hari</td>"+
