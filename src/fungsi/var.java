...
public final class var {
    ...
    private static boolean admin=false,user=false,vakum=false,aplikasi=false,penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,
            ...
            data_HAIs=false,harian_HAIs=false,bulanan_HAIs=false,hitung_bor=false, hemodialisa = false, resep_dokter=false, lama_pelayanan_apotek=false,
            bpjs_rujukan_keluar=false,bpjs_cek_nomor_rujukan_rs=false,bpjs_cek_rujukan_kartu_pcare=false,bpjs_cek_rujukan_kartu_rs=false,kategori_barang=false,
            golongan_barang=false,pemberian_obat_pertanggal=false,penjualan_obat_pertanggal=false,akses_depo_obat=false,pengeluaran_stok_apotek=false,
            surat_pemesanan_medis=false,permintaan_medis=false,rekap_permintaan_medis=false,hitung_alos=false,detail_tindakan=false,rekap_poli_anak=false,
       ...
       try {                
                ...
                try {
                    ...
                    if(rs.getRow()>=1){
                        ...
                        var.hemodialisa = rs2.getBoolean("hemodialisa");
    ...
    public static boolean getHemodialisa() { return var.hemodialisa; }
