...
public final class DlgHitungBOR extends javax.swing.JDialog {
    ...
    public DlgHitungBOR(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.Rawat","Nomer RM","Nama Pasien","Kamar","Tgl.Masuk","Tgl.Keluar","Lama"};
    ...
    public void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                       "select kamar_inap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,concat(kamar_inap.kd_kamar,' ',bangsal.nm_bangsal)," +
                       "kamar_inap.tgl_masuk,if(kamar_inap.tgl_keluar='0000-00-00',?,kamar_inap.tgl_keluar),lama "+
                       ...
                       "where   order by kamar_inap.tgl_masuk");
