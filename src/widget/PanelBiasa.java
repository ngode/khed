...
public class PanelBiasa extends JPanel{
    ...
    private Color warnaAtas = GColors.Biru40;// new Color(250,255,245) ;
    private Color warnaBawah = GColors.Biru50;// new Color(245,250,240) ;
    ...
    public PanelBiasa(){
        super();
        this.setBorder(javax.swing.BorderFactory.createLineBorder(GColors.Biru15));// new Color(237,242,232)));
    }
