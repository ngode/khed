...
public class CustomTabbedPaneUI extends BasicTabbedPaneUI {
    ...
    @Override
    protected void paintText(Graphics g, int tabPlacement, Font fontl, FontMetrics metricsl, int tabIndex, String title, Rectangle rect, boolean isSelected) {
        
        Font font = new java.awt.Font("Tahoma", 0, 11);
        FontMetrics metrics = g.getFontMetrics(font);
        Rectangle rectd = new Rectangle(rect.x + (rect.width - metrics.stringWidth(title)) / 2, 
                rect.y + ((rect.height - metrics.getHeight()) / 2), 
                rect.width, 
                rect.height);
        
        super.paintText(g, tabPlacement, font, metrics, tabIndex, title, rectd, isSelected);
//        g.setFont(font);
