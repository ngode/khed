 ...
 * @author dosen
 */
public final class DlgOrderHemodialisa extends javax.swing.JDialog
{
     ...
     * @param modal
     */
    public DlgOrderHemodialisa(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents()
    {
        ...
        txtKdPetugas.setBounds(520, 70, 80, 23);
        ...
        btnPetugas.setBounds(810, 70, 28, 23);

        NmPtg.setEditable(false);
        NmPtg.setName("NmPtg"); // NOI18N
        PanelInput.add(NmPtg);
        NmPtg.setBounds(605, 70, 195, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        {
            Valid.textKosong(txtKdKamar, "Kamar");
        }
        else if (txtKdDokter.getText().equals("") || txtNamaDokter.getText().equals(""))
        {
            Valid.textKosong(txtKdDokter, "Dokter Perujuk");
        }
        else if (txtKdPetugas.getText().equals("") || NmPtg.getText().equals(""))
        {
            Valid.textKosong(txtKdPetugas, "Petugas");
        }
        ...
        else
        {
            ...
            if (reply == JOptionPane.YES_OPTION)
            {
                ...
                else
                {
                    ...
                    success &= Sequel.menyimpantf2("pemeriksaan_hd", "?,?,?,?,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,?,NULL,NULL,NULL,?,?,?,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL", "-", 8, new String[]
                    {
                        kdPeriksa,
                        txtNoRw.getText(),
...
//        }
    ...
    {//GEN-HEADEREND:event_ChkJlnActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ChkJlnActionPerformed

    private void TanggalKeyPressed(java.awt.event.KeyEvent evt)//GEN-FIRST:event_TanggalKeyPressed
    {//GEN-HEADEREND:event_TanggalKeyPressed
    ...
    public static void main(String args[])
    {
        java.awt.EventQueue.invokeLater(() -> 
                {
                    DlgOrderHemodialisa dialog = new DlgOrderHemodialisa(new javax.swing.JFrame(), true);
...
//        BtnSimpan.setEnabled(var.getperiksa_());
//        BtnTambahPeriksa.setEnabled(var.gettarif_radiologi());
    ...
    private void ubahOrder()
    {
        ...
        Sequel.cariIsi("SELECT nip FROM pemeriksaan_hd WHERE kd_periksa = ?", txtKdPetugas, kdPeriksa);
        Sequel.cariIsi("SELECT nama FROM petugas WHERE nip = ?", NmPtg, txtKdPetugas.getText());
