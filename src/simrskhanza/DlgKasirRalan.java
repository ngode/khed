...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private PreparedStatement psotomatis,psotomatis2,pskasir,pscaripiutang,pskonsul;
    private ResultSet rskasir,rskonsul;
    ...
    private DlgPemberianDiet_Ralan diet = new DlgPemberianDiet_Ralan(null, false);
    ...
    public DlgKasirRalan(java.awt.Frame parent, boolean modal) {
        ...
        txtCariKdPoli.setDocument(new batasInput((byte)100).getKata(txtCariKdPoli));
                ...
                if(var.getform().equals("DlgKasirRalan")){
                    if(billing.poli.getTable().getSelectedRow()!= -1){
                        ...
                        // Kalo filter poli
                            ...
                            txtCariKdPoli.setText(billing.poli.getTable().getValueAt(billing.poli.getTable().getSelectedRow(),0).toString());
                            txtCariNamaPoli.setText(billing.poli.getTable().getValueAt(billing.poli.getTable().getSelectedRow(),1).toString());
                            txtCariKdPoli.requestFocus();                            
                        }                        
                    }                      
                }
            }
        ...
        // Biar kalo filter poli berubah langsung refresh
        txtCariNamaPoli.addTextChangedListener(t -> tampilkasir());
    }
    ...
    private void initComponents()
    {
        ...
        MnPeriksaHd = new javax.swing.JMenuItem();
        ...
        MnKonsul = new javax.swing.JMenu();
        MnaddKonsul = new javax.swing.JMenuItem();
        MnEditKonsul = new javax.swing.JMenuItem();
        MnHapusKonsul = new javax.swing.JMenuItem();
        ...
        txtCariKdPoli = new widget.TextBox();
        txtCariNamaPoli = new widget.TextBox();
        ...
        MnResepDOkter.setForeground(new java.awt.Color(90, 120, 80));
        ...
        MnPeriksaHd.setBackground(new java.awt.Color(255, 255, 255));
        MnPeriksaHd.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPeriksaHd.setForeground(new java.awt.Color(60, 80, 50));
        MnPeriksaHd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPeriksaHd.setText("Periksa HD");
        MnPeriksaHd.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnPeriksaHd.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnPeriksaHd.setName("MnPeriksaHd"); // NOI18N
        MnPeriksaHd.setPreferredSize(new java.awt.Dimension(220, 26));
        MnPeriksaHd.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                MnPeriksaHdActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnPeriksaHd);
        ...
        ppBerkasDigital.setForeground(new java.awt.Color(60, 80, 50));
        ppBerkasDigital.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppBerkasDigital.setText("Riwayat Perawatan");
        ...
        MnKonsul.setBackground(new java.awt.Color(248, 253, 243));
        ...
        MnKonsul.setOpaque(true);
        MnKonsul.setPreferredSize(new java.awt.Dimension(220, 26));

        MnaddKonsul.setBackground(new java.awt.Color(255, 255, 255));
        MnaddKonsul.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnaddKonsul.setForeground(new java.awt.Color(60, 80, 50));
        MnaddKonsul.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnaddKonsul.setText("Konsul Poli");
        MnaddKonsul.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnaddKonsul.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnaddKonsul.setName("MnaddKonsul"); // NOI18N
        MnaddKonsul.setPreferredSize(new java.awt.Dimension(220, 26));
        MnaddKonsul.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                MnaddKonsulActionPerformed(evt);
            }
        });
        MnKonsul.add(MnaddKonsul);

        MnEditKonsul.setBackground(new java.awt.Color(255, 255, 255));
        MnEditKonsul.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnEditKonsul.setForeground(new java.awt.Color(60, 80, 50));
        MnEditKonsul.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnEditKonsul.setText("Edit Konsul Poli");
        MnEditKonsul.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnEditKonsul.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnEditKonsul.setName("MnEditKonsul"); // NOI18N
        MnEditKonsul.setPreferredSize(new java.awt.Dimension(220, 26));
        MnEditKonsul.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                MnEditKonsulActionPerformed(evt);
            }
        });
        MnKonsul.add(MnEditKonsul);

        MnHapusKonsul.setBackground(new java.awt.Color(255, 255, 255));
        MnHapusKonsul.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnHapusKonsul.setForeground(new java.awt.Color(60, 80, 50));
        MnHapusKonsul.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnHapusKonsul.setText("Hapus Konsul Poli");
        MnHapusKonsul.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnHapusKonsul.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnHapusKonsul.setName("MnHapusKonsul"); // NOI18N
        MnHapusKonsul.setPreferredSize(new java.awt.Dimension(220, 26));
        MnHapusKonsul.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                MnHapusKonsulActionPerformed(evt);
            }
        });
        MnKonsul.add(MnHapusKonsul);
        ...
        CrPtg.setPreferredSize(new java.awt.Dimension(230, 23));
        ...
        txtCariKdPoli.setEditable(false);
        txtCariKdPoli.setName("txtCariKdPoli"); // NOI18N
        txtCariKdPoli.setPreferredSize(new java.awt.Dimension(80, 23));
        txtCariKdPoli.addKeyListener(new java.awt.event.KeyAdapter()
        {
            public void keyPressed(java.awt.event.KeyEvent evt)
            {
                txtCariKdPoliKeyPressed(evt);
            }
        });
        panelGlass7.add(txtCariKdPoli);

        txtCariNamaPoli.setEditable(false);
        txtCariNamaPoli.setName("txtCariNamaPoli"); // NOI18N
        txtCariNamaPoli.setPreferredSize(new java.awt.Dimension(230, 23));
        panelGlass7.add(txtCariNamaPoli);
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void MnaddKonsulActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_MnaddKonsulActionPerformed
    {//GEN-HEADEREND:event_MnaddKonsulActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
        ...
        else if (tbKasirRalan.getSelectedRow() == -1)
        {
            ...
            String Tgl = tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 12).toString();
            ...
            popKonsul.setTgl(Tgl);
            popKonsul.setKondisi(1);
            popKonsul.setLocationRelativeTo(internalFrame1);
            popKonsul.setVisible(true);
        }
    }//GEN-LAST:event_MnaddKonsulActionPerformed

    private void MnPeriksaHdActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_MnPeriksaHdActionPerformed
    {//GEN-HEADEREND:event_MnPeriksaHdActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
            ...
            dlgPeriksaHd.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
            dlgPeriksaHd.setLocationRelativeTo(internalFrame1);
            dlgPeriksaHd.emptTeks();
            dlgPeriksaHd.setNoRm(TNoRw.getText(), "Ralan");
            dlgPeriksaHd.tampil();
            dlgPeriksaHd.isCek();
            dlgPeriksaHd.setVisible(true);          
        }
...
//        }
    ...
    private void MnEditKonsulActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnEditKonsulActionPerformed
        // TODO add your handling code here:
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        ...
        else if (tbKasirRalan.getSelectedRow() == -1)
        {
            ...
            String noRm = tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),11).toString();
            String noRw = TNoRw.getText();
            String kdDok = tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 0).toString();
            String nmDok = tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 1).toString();
            String kdKonsul = tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 15).toString();
            String kdPoli = getKdPoli(kdKonsul);
            String nmPoli = tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 4).toString();
            String biaya = tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 8).toString();
            
         
            popKonsul.setSize(530,200);
            popKonsul.setParentSixe(internalFrame1.getWidth(), internalFrame1.getHeight());
            popKonsul.setData(noRm, noRw);
            popKonsul.setText(kdDok,nmDok,kdPoli,nmPoli,biaya);
            popKonsul.setkdKonsul(kdKonsul);
            popKonsul.setKondisi(2);
            popKonsul.setKdPoli(getKdPoli(kdKonsul));
//            System.out.println("kd : "+getKdPoli(noRm, kdDok));
            popKonsul.setLocationRelativeTo(internalFrame1);
            popKonsul.setVisible(true);
        }
    }//GEN-LAST:event_MnEditKonsulActionPerformed

    private void MnHapusKonsulActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusKonsulActionPerformed
        // TODO add your handling code here:
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        ...
        else if (tbKasirRalan.getSelectedRow() == -1)
        {
            ...
            boolean del=false,del1;
            String kdKonsul = tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 15).toString();
            
            
           del = Sequel.queryutf("delete from konsul_poli where kd_kosul='"+kdKonsul+"'");
           if(del == true){
              JOptionPane.showMessageDialog(null,"Berhasil di Hapus");
              tampilkasir();
           }else{
               JOptionPane.showMessageDialog(null,"Maaf, Hapus Gagal...!!!");
                tampilkasir();
           }        
        }
    }//GEN-LAST:event_MnHapusKonsulActionPerformed
 ...
 if(tabModekasir.getRowCount()==0){
            ...
            diet.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
            diet.setLocationRelativeTo(internalFrame1);
            diet.emptTeks();
            diet.setNoRm(TNoRw.getText(),DTPCari1.getDate(),DTPCari2.getDate());
            diet.tampil();
            diet.isCek();
    ...
    private void txtCariKdPoliKeyPressed(java.awt.event.KeyEvent evt)//GEN-FIRST:event_txtCariKdPoliKeyPressed
    {//GEN-HEADEREND:event_txtCariKdPoliKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER)
        {
            Sequel.cariIsi("SELECT nm_poli FROM poliklinik WHERE kd_poli = ?", txtCariNamaPoli, txtCariKdPoli.getText());
            
            if (txtCariNamaPoli.getText().isEmpty())
            {
                txtCariKdPoli.setText("");
            }
        }
    }//GEN-LAST:event_txtCariKdPoliKeyPressed
    ...
    */
    ...
    private javax.swing.JMenuItem MnEditKonsul;
    ...
    private javax.swing.JMenuItem MnHapusKonsul;
    ...
    private javax.swing.JMenu MnKonsul;
    ...
    private javax.swing.JMenuItem MnPeriksaHd;
    ...
    private javax.swing.JMenuItem MnaddKonsul;
    ...
    private widget.TextBox txtCariKdPoli;
    private widget.TextBox txtCariNamaPoli;
    ...
    public void tampilkasir() {                   
        ...
        // Kalo filter poli gak kosong
        if (!txtCariNamaPoli.getText().isEmpty())
        {
            filterPoli = "AND poliklinik.kd_poli = '" + txtCariKdPoli.getText() + "'";
        }
        ...
        try{   
            pskasir=koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                ...
                " reg_periksa.status_lanjut='Ralan' " + filterPoli + " and dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and reg_periksa.no_reg like ? or "+
                " reg_periksa.status_lanjut='Ralan' " + filterPoli + " and dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  reg_periksa.no_rawat like ? or "+
                " reg_periksa.status_lanjut='Ralan' " + filterPoli + " and dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  reg_periksa.tgl_registrasi like ? or "+
                " reg_periksa.status_lanjut='Ralan' " + filterPoli + " and dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  reg_periksa.kd_dokter like ? or "+
                " reg_periksa.status_lanjut='Ralan' " + filterPoli + " and dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  dokter.nm_dokter like ? or "+
                " reg_periksa.status_lanjut='Ralan' " + filterPoli + " and dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  reg_periksa.no_rkm_medis like ? or "+
                " reg_periksa.status_lanjut='Ralan' " + filterPoli + " and dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  pasien.nm_pasien like ? or "+
                " reg_periksa.status_lanjut='Ralan' " + filterPoli + " and dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  reg_periksa.p_jawab like ? or "+
                " reg_periksa.status_lanjut='Ralan' " + filterPoli + " and dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  penjab.png_jawab like ? or "+
                " reg_periksa.status_lanjut='Ralan' " + filterPoli + " and dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  reg_periksa.almt_pj like ? or "+
                " reg_periksa.status_lanjut='Ralan' " + filterPoli + " and dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  reg_periksa.hubunganpj like ? order by reg_periksa.no_rawat desc");
            try {
            ...
            try{
                ...
                pskasir.setString(parIndex++,"%"+CrPtg.getText()+"%");
                pskasir.setString(parIndex++,"%"+cmbStatus.getSelectedItem().toString().replaceAll("Semua","")+"%");
                pskasir.setString(parIndex++,Valid.SetTgl(DTPCari1.getSelectedItem()+""));
                pskasir.setString(parIndex++,Valid.SetTgl(DTPCari2.getSelectedItem()+""));
                pskasir.setString(parIndex++,"%"+TCari.getText().trim()+"%");
                ...
                while (rskonsul.next()) { 
                        tabModekasir.addRow(new Object[] {
                                   rskonsul.getString(5),
                                   rskonsul.getString(6),
                                   rskonsul.getString(7),
                                   rskonsul.getString(8),
                                   rskonsul.getString(9),
                                   rskonsul.getString(10),
                                   rskonsul.getString(11),
                                   rskonsul.getString(12),
                                   rskonsul.getString(13),
                                   rskonsul.getString("png_jawab"),
                                   rskonsul.getString(14),
                                   rskonsul.getString("no_rawat"),
    ...
    private String getKdPoli(String kdKonsul){
        String res = null;
        res = Sequel.cariIsi("SELECT konsul_poli.kd_poli FROM konsul_poli  WHERE  konsul_poli.kd_kosul ='"+kdKonsul+"'");
        return res;
    }
    ...
    public void isCek(){
        ...
        // Ini gak aplikatif karena terlalu banyak client, jadi gak bisa set satu-satu per komputer
        try {
        ...
        if(!namapoli.equals("")){
            if(var.getkode().equals("Admin Utama")){
                ...
                txtCariKdPoli.setEditable(true);
            }else{
                txtCariKdPoli.setText(namapoli);
        ...
        // Buat set otomatis kalau yang login dari poli tertentu
        // Belum bisa karena belum ada kolom kd_poli di tabel user
    }
