 ...
 * @author GrT
 */
public class DlgOrderOperasi extends javax.swing.JDialog
{
     ...
     * @param modal
     */
    public DlgOrderOperasi(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    ...
    private void simpan()
    {
        ...
        if (GMessage.q("Konfirmasi", "Data sudah benar?"))
        {
            ...
            if (b)
            {
                GMessage.i("Sukses", "Order operasi berhasil");
