 ...
 * @author dosen
 */
public class DlgLihatPemberianDiet extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgLihatPemberianDiet(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"No.Rawat","Nama Pasien","Kamar","Tanggal","Waktu","Diagnosa",
            "Bentuk Makanan", "Jenis Diet", "Ekstra"};
    ...
    private void initComponents() {
        ...
        btnGiziRalan = new javax.swing.JButton();
        ...
        btnGiziRalan.setText("Gizi Ralan");
        btnGiziRalan.setName("btnGiziRalan"); // NOI18N
        btnGiziRalan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGiziRalanActionPerformed(evt);
            }
        });
        panelGlass7.add(btnGiziRalan);
        btnGiziRalan.setBounds(590, 10, 90, 23);
    ...
    private void btnGiziRalanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGiziRalanActionPerformed
        // TODO add your handling code here:
 var.setform("DlgLihatPemberianDiet");        
        
        dietRalan.setSize(internalFrame1.getWidth()-40,internalFrame1.getHeight()-40);
        dietRalan.setLocationRelativeTo(internalFrame1);
        dietRalan.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnGiziRalanActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgLihatPemberianDiet dialog = new DlgLihatPemberianDiet(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JButton btnGiziRalan;
