 ...
 * @author perpustakaan
 */
public class DlgCariNoRawat2 extends BaseDialog {
     ...
     * @param parent
       @param modal */
    public DlgCariNoRawat2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        MnPeriksaHd.setText("Periksa Hemodialisa");
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-01-2018" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-01-2018" }));
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-01-2018" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-01-2018" }));
...
//        }
        else
        {
            ...
            dlgPeriksaHd.setNoRm(norawat.getText(), "Ranap");
            dlgPeriksaHd.tampil();
            dlgPeriksaHd.isCek();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariNoRawat2 dialog = new DlgCariNoRawat2(new javax.swing.JFrame(), true);
    ...
    public void setNoRm(String norwt) {
        ...
        Sequel.cariIsi("select no_rkm_medis from reg_periksa where no_rawat=? ",TNoRM,norawat.getText());
        Sequel.cariIsi("select nm_pasien from pasien where no_rkm_medis=? ",TPasien,TNoRM.getText());
        Sequel.cariIsi("SELECT GROUP_CONCAT(CONCAT(' ', nm_penyakit)) FROM diagnosa_pasien JOIN penyakit ON penyakit.kd_penyakit = diagnosa_pasien.kd_penyakit WHERE no_rawat = ?", diagnosaawal, norwt);
        R1.setSelected(true);        
        TCari.setText(norwt);
        try {    
