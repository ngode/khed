 ...
 * @author dosen
 */
public final class DlgOrderLab extends javax.swing.JDialog
{
     ...
     * @param modal
     */
    public DlgOrderLab(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    ...
    private void initTable()
    {
        ...
        Object[] row =
        {
            "P", "Kode Periksa", "Nama Pemeriksaan", "rs", "Material", "Bhp", "Dokter", "Perawat", "Kso", "Manajemen", "Tarif"
        };
    ...
    private void initComponents() {
        ...
        tblPemeriksaan11 = new widget.Table();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Input Order Laboratorium ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 40))); // NOI18N
        ...
        jPanel3.add(Scroll2, java.awt.BorderLayout.LINE_START);

        Scroll4.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(245, 255, 235)));
        Scroll4.setName("Scroll4"); // NOI18N
        Scroll4.setOpaque(true);
        Scroll4.setPreferredSize(new java.awt.Dimension(152, 62));

        tblPemeriksaan11.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tblPemeriksaan11.setName("tblPemeriksaan11"); // NOI18N
        tblPemeriksaan11.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblPemeriksaan11MouseClicked(evt);
            }
        });
        tblPemeriksaan11.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tblPemeriksaan11KeyPressed(evt);
            }
        });
        Scroll4.setViewportView(tblPemeriksaan11);
    ...
    private void tblPemeriksaan11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPemeriksaan11MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tblPemeriksaan11MouseClicked

    private void tblPemeriksaan11KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblPemeriksaan11KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tblPemeriksaan11KeyPressed
    ...
    public static void main(String args[])
    {
        java.awt.EventQueue.invokeLater(() -> 
                {
                    DlgOrderLab dialog = new DlgOrderLab(new javax.swing.JFrame(), true);
    ...
    private widget.Table tblPemeriksaan1;
    private widget.Table tblPemeriksaan11;
