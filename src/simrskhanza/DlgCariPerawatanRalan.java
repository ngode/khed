...
import simrskhanza.cari.DlgCariGroupTindRalan;
...
public final class DlgCariPerawatanRalan extends javax.swing.JDialog
{
    ...
    public DlgCariPerawatanRalan(java.awt.Frame parent, boolean modal)
    {
        ...
        {
            TCariTindakan.addTextChangedListener(t -> tampil());
        }
    ...
    private void initComponents()
    {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-05-2018" }));
...
private void ppPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppPetugasActionPerformed
    ...
    {//GEN-HEADEREND:event_cmbCariGroupActionPerformed
        DlgCariGroupTindRalan d = new DlgCariGroupTindRalan(null, true);
    ...
    {//GEN-HEADEREND:event_txtKdGroupKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER)
        {
            Sequel.cariIsi("SELECT nm_group FROM hrj_group_ralan WHERE kd_group = ?", txtNamaGroup, txtKdGroup.getText());
    ...
    public void tampil()
    {
        try
        {
            ...
            // KETERANGAN === 
            // Yang dipake yg pstindakan4 aja ya, karena tarif jadi satu
            // Filter per poli = NO, Per cara bayar = NO
            // ABAIKAN ==
            pstindakan = koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori, poliklinik.nm_poli, "
                    ...
                    + "join poliklinik on poliklinik.kd_poli = jns_perawatan.kd_poli "
            ...
            // Yang dieksekusi pasti ini ==
            pstindakan4 = koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan, kd_kategori, '-', "
                    + "jns_perawatan.total_byrdr,jns_perawatan.total_byrpr,jns_perawatan.total_byrdrpr,jns_perawatan.bhp,jns_perawatan.material,"
                    + "jns_perawatan.tarif_tindakandr,jns_perawatan.tarif_tindakanpr,jns_perawatan.kso,jns_perawatan.menejemen "
                    + "from jns_perawatan "
                    + "where kd_kategori = ? AND jns_perawatan.status='1' "
            ...
            try
            {
                ...
                {
                    pstindakan4.setString(1, txtKdGroup.getText());
