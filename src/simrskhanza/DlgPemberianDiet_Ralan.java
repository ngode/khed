 ...
 * @author dosen
 */
public class DlgPemberianDiet_Ralan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPemberianDiet_Ralan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(1300,674);

        Object[] row={"No.Rawat","Nama Pasien","Tanggal","Waktu","Bentuk Makanan", "Jenis Diet", "Ekstra","Status"};
        ...
        try {
            ps=koneksi.prepareStatement("select detail_beri_diet_ralan.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, " +
                ...
                "where detail_beri_diet_ralan.tanggal between ? and ? and detail_beri_diet_ralan.waktu like ? and detail_beri_diet_ralan.no_rawat like ? or " +
                "detail_beri_diet_ralan.tanggal between ? and ? and detail_beri_diet_ralan.waktu like ? and reg_periksa.no_rkm_medis like ? or " +
                "detail_beri_diet_ralan.tanggal between ? and ? and detail_beri_diet_ralan.waktu like ? and pasien.nm_pasien like ? " +
                "order by detail_beri_diet_ralan.bentuk_makanan, detail_beri_diet_ralan.jenis_diet");
            ps2=koneksi.prepareStatement("select detail_beri_diet_ralan.jenis_diet, count(detail_beri_diet_ralan.jenis_diet) as jumlah " +
                "from detail_beri_diet_ralan inner join reg_periksa inner join pasien " +
                "on detail_beri_diet_ralan.no_rawat=reg_periksa.no_rawat " +
                "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "where detail_beri_diet_ralan.tanggal between ? and ? and detail_beri_diet_ralan.waktu like ? and detail_beri_diet_ralan.no_rawat like ? or "+
                "detail_beri_diet_ralan.tanggal between ? and ? and detail_beri_diet_ralan.waktu like ? and reg_periksa.no_rkm_medis like ? or "+
                "detail_beri_diet_ralan.tanggal between ? and ? and detail_beri_diet_ralan.waktu like ? and pasien.nm_pasien like ? "+
                "group by detail_beri_diet_ralan.jenis_diet order by detail_beri_diet_ralan.jenis_diet");
        }catch (Exception e) {
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-03-2018" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-03-2018" }));
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-03-2018" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            Sequel.menyimpan("detail_beri_diet_ralan","'"+TNoRw.getText()+"','"+
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPemberianDiet_Ralan dialog = new DlgPemberianDiet_Ralan(new javax.swing.JFrame(), true);
    ...
    public void tampil() {     
        try{
            ...
            ps.setString(7,"%"+cmbJamCari.getSelectedItem().toString().replaceAll("Semua","").trim()+"%");
            ps.setString(8,"%"+TCari.getText().trim()+"%");
            ps.setString(9,Valid.SetTgl(DTPCari1.getSelectedItem()+""));
            ps.setString(10,Valid.SetTgl(DTPCari2.getSelectedItem()+""));
            ps.setString(11,"%"+cmbJamCari.getSelectedItem().toString().replaceAll("Semua","").trim()+"%");
        ...
        try{
            ...
            ps2.setString(7,"%"+cmbJamCari.getSelectedItem().toString().replaceAll("Semua","").trim()+"%");
            ...
            ps2.setString(11,"%"+cmbJamCari.getSelectedItem().toString().replaceAll("Semua","").trim()+"%");
