 ...
 * @author dosen
 */
public final class DlgCariDetailOperasi extends BaseDialog
{
     ...
     * @param modal
     */
    public DlgCariDetailOperasi(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents()
    {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Detail Operasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 40))); // NOI18N
    ...
    public static void main(String args[])
    {
        java.awt.EventQueue.invokeLater(() -> 
                {
                    DlgCariDetailOperasi dialog = new DlgCariDetailOperasi(new javax.swing.JFrame(), true);
    ...
    public void tampil()
    {
        ...
        try
        {
            ps = koneksi.prepareStatement("select kd_detail, nm_detail "
                    + " from operasi_detail where (kd_detail like ? OR nm_detail like ?) AND kd_kategori = ? order by nm_detail");
            try
            {
                ps.setString(1, "%" + txtCari.getText().trim() + "%");
                ps.setString(2, "%" + txtCari.getText().trim() + "%");
                ps.setString(3, kdKategori);
