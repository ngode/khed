 ...
 * @author dosen
 */
public final class DlgCariGroupOperasi extends BaseDialog
{
     ...
     * @param modal
     */
    public DlgCariGroupOperasi(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[])
    {
        java.awt.EventQueue.invokeLater(() -> 
                {
                    DlgCariGroupOperasi dialog = new DlgCariGroupOperasi(new javax.swing.JFrame(), true);
    ...
    public void tampil()
    {
        ...
        try
        {
            ps = koneksi.prepareStatement("select kd_group, nm_group "
                    + " from operasi_group where kd_group like ? OR nm_group like ? order by nm_group");
            try
            {
