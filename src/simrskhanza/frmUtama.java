...
public class frmUtama extends javax.swing.JFrame {
    ...
    private final DlgMonitoringRm dlgMonitoringRm = new DlgMonitoringRm(this, false);
    ...
    private void initComponents() {
        ...
        btnPerusahaan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/48x48/bedroom.png"))); // NOI18N
        ...
        btnBerkasDigitalPerawatan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/48x48/mp_viewer.png"))); // NOI18N
        ...
        btnPermintaanMedis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/48x48/1360816018_tests.png"))); // NOI18N
        ...
        btnRekapPermintaanMedis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/48x48/1360816018_tests.png"))); // NOI18N
        ...
        btnSuratPemesananMedis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/48x48/1360816018_tests.png"))); // NOI18N
        ...
        tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03/05/2018" }));
        ...
        internalFrame1.setWarnaAtas(new java.awt.Color(154, 222, 255));
        internalFrame1.setWarnaBawah(new java.awt.Color(106, 195, 220));
        ...
        internalFrame4.setWarnaAtas(new java.awt.Color(154, 222, 255));
        internalFrame4.setWarnaBawah(new java.awt.Color(106, 195, 220));
...
private void BtnMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnMenuActionPerformed
        ...
        try{            
            if(prop.getProperty("MENUTRANSPARAN").equals("yes")){
                com.sun.awt.AWTUtilities.setWindowOpacity(DlgHome,0.8f);
            }                
        }catch(Exception e){
            
        }
        
        DlgHome.setSize(PanelUtama.getWidth()-6, PanelUtama.getHeight()-6);
        isTampil();
...
private void BtnSimpanPassKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanPassKeyPressed
    ...
    private void btnDietActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDietActionPerformed
        ...
        DlgHome.dispose();
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR)); 
        //DlgLihatPemberianDiet lihatBeriDiet = new DlgLihatPemberianDiet(this, false);
        DlgLihatDiet lihatBeriDiet = new DlgLihatDiet(this, false);
        //DlgTagihanOperasi form=new DlgTagihanOperasi(null,false);
        lihatBeriDiet.setSize(PanelUtama.getWidth(),PanelUtama.getHeight());
        lihatBeriDiet.setLocationRelativeTo(PanelUtama);
        lihatBeriDiet
                .setVisible(true);
        this.setCursor(Cursor.getDefaultCursor());
    ...
    private void btnToolLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnToolLabActionPerformed
        ...
        DlgPemeriksaanLaboratorium form = new DlgPemeriksaanLaboratorium(null, false);
        form.setSize(PanelUtama.getWidth(),PanelUtama.getHeight());
        form.setLocationRelativeTo(PanelUtama);
        form.setVisible(true);
        this.setCursor(Cursor.getDefaultCursor());
...
//        Hybrid.setVisible(true);        
    ...
    private void btnPerusahaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPerusahaanActionPerformed
        isTutup();
        DlgHome.dispose();
        DlgPerusahaan perusahaan=new DlgPerusahaan(this, false);
    ...
    {//GEN-HEADEREND:event_btnToolOperasiActionPerformed
        ...
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));  
        //DlgTagihanOperasi form=new DlgTagihanOperasi(null,false);
        DlgPemeriksaanOperasi2 form=new DlgPemeriksaanOperasi2(null,false);
        form.setSize(PanelUtama.getWidth(),PanelUtama.getHeight());
        form.setLocationRelativeTo(PanelUtama);
        form.setVisible(true);
        this.setCursor(Cursor.getDefaultCursor());
