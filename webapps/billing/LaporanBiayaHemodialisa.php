...
<html>
    ...
    reportsqlinjection();      
        ...
        if(mysql_num_rows($hasil)!=0) { 
                  ...
                  <table width='100%' bgcolor='#ffffff' align='left' border='0' cellpadding='0' cellspacing='0' >
                     ...
                     "; 
                        ...
                        while($item = mysql_fetch_array($hasil)) {
                           if($item[0]<>"Total Biaya Pemeriksaan Hemodialisa"){
                              echo "<tr class='isi'>
                           ...
                           }else if($item[0]=="Total Biaya Pemeriksaan Hemodialisa"){
                               echo "<tr>
                                        <td><font color='000000' size='1'  face='Tahoma'></font></td>
            ...
            ";  
        } else {echo "<font color='000000' size='1'  face='Times New Roman'><b>Data Pemeriksaan Hemodialisa masih kosong !</b>";}
